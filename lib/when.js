...
(function(){
	window.defineW = function(factory) {
	    try{ delete window.defineW; } catch(e){ window.defineW = void 0; } // IE
	    window.when = factory();
	};
	window.defineW.amd = {};
})();
...
(function(defineW, global) { 'use strict';
defineW(function () {
	...
	typeof defineW === 'function' && defineW.amd ? defineW : function (factory) { module.exports = factory(); },
	this
);
