...
define(["app"], function(app) {
    ...
    function init(query) {
        ...
        title = tempStr + getI18NText('real-overtime'); //谁发起的申请
        id = query.id;
        ...
        var url = ess_getUrl("ess/EOT/getOverTimeDetailInfo/");
    ...
    function clickAction(e) {
        ...
        var back_url = "./js/myOverTime/myOverTimeApprove/myOverTimeApprove.html";
        if(from !== undefined && from !== null){
            back_url = "./js/myApprove/myApprove.html";
        }
